...
<div class="col-md-8 col-12" v-for="profile in searchedProfiles" :key="profile.id">
  ...
  <div class="row ">
      ...
      <div class="row">
        ...
        <div class="col-12 p-2">
            ...
            <div class="d-flex justify-content-between">
              ...
              <p class="text-dark mb-0">{{ profile.class }}</p>
            </div>
          </div>
        </router-link>
    ...
    <div>
      <img class="profileImg" :src="profile.imgUrl" alt="" data-bs-toggle="modal" data-bs-target="#projectModal" >
      {{ profile.body }}
    </div>
    </div>
